...
@test "LLAMA_CMAKE_KNOBS contains exactly the expected cmake knobs" {
    ...
    run bash -c "
        source '${BATS_TEST_DIRNAME}/../config.sh' 2>/dev/null
        expected='CMAKE_BUILD_TYPE CMAKE_CUDA_ARCHITECTURES CMAKE_CUDA_FLAGS GGML_CUDA GGML_CUDA_FA_ALL_QUANTS GGML_CUDA_GRAPHS GGML_NATIVE GGML_BLAS GGML_BLAS_VENDOR LLAMA_BUILD_TESTS'
